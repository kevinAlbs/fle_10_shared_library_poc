 ...
 *
 * This function may be called before `mongo_csfle_v1_lib_init`.
 *
...
mongo_csfle_v1_status_destroy(mongo_csfle_v1_status* status);
 ...
 * mongo_csfle_v1_lib_init() has not been called previously.
 */
 ...
 */
MONGO_CSFLE_API mongo_csfle_v1_query_analyzer* MONGO_API_CALL mongo_csfle_v1_query_analyzer_create(
 ...
 *
 * The 'analyzer' and 'documentBSON' parameters must point to initialized objects of their respective
 * types.
 *
 * When the analysis is successful, this function returns non-null value which points to a valid BSON
 * document and updates bson_len with the length of the BSON document
 */
...
/**
 * Free the memory of a BSON buffer returned by mongo_csfle_v1_analyze_query(). This function can be safely called on a NULL pointer.
 *
